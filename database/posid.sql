...
INSERT INTO `dt_piutang` (`id`, `nama_upt`, `bisnis`, `nama_pel`, `prod`, `bsu`, `total_piutang`, `pajak`, `saldo_akhir`, `sebulan`, `duabulan`, `tigabulan`, `statusp`, `tgl`) VALUES
(3, 'Prabumulih', 'SURAT', 'Clipan Finance', 20, 147500, 147500, 0, 0, 0, 0, 0, '1', '2020-10-02 23:54:51.000000'),
(5, 'Prabumulih', 'PAKET', 'Clipan Finance', 25, 375000, 375000, 0, 0, 0, 0, 0, '1', '2020-09-24 16:05:10.000000'),
(89, 'Prabumulih', 'SURAT', 'Clipan Finance', 23, 345000, 345000, 0, 0, 0, 0, 0, '1', '2020-10-13 16:24:03.000000'),
(90, 'Prabumulih', 'PAKET', 'Dipo Star Finance', 15, 225000, 225000, 0, 0, 0, 0, 0, '0', '2020-10-21 18:55:29.000000'),
(91, 'Prabumulih', 'PAKET', 'Indomobil', 10, 150000, 150000, 0, 0, 0, 0, 0, '0', '2020-10-20 18:56:00.000000'),
(94, 'Prabumulih', 'PAKET', 'RSUD', 14, 210000, 210000, 0, 0, 0, 0, 0, '0', '2020-12-10 00:09:41.000000');
...
--
-- Table structure for table `tbl_bisnis`
--

CREATE TABLE `tbl_bisnis` (
  `id_bisnis` int(11) NOT NULL,
  `bisnis` varchar(25) NOT NULL,
  `nama_upt` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_bisnis`
--

INSERT INTO `tbl_bisnis` (`id_bisnis`, `bisnis`, `nama_upt`) VALUES
(1, 'PAKET', 'Prabumulih'),
(2, 'SURAT', 'Prabumulih'),
(3, 'KARGO', 'Prabumulih');
...
--
-- AUTO_INCREMENT for table `tbl_bisnis`
--
ALTER TABLE `tbl_bisnis`
